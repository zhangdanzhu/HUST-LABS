...
EAStep vivado -log D_ff_with_ce_and_synch_reset_behavior.vds -m64 -mode batch -messageDb vivado.pb -notrace -source D_ff_with_ce_and_synch_reset_behavior.tcl
